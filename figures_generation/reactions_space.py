...
def plot_reaction_space(counter, fuse_model, prot_emd_type, mol_emd_type, pretrained_method=2):
    ...
    plt.scatter(mol_no_reactions[:, 0], mol_no_reactions[:, 1], c='gray', marker='o', s=5, label='Molecule')
    plt.scatter(prot_no_reactions[:, 0], prot_no_reactions[:, 1], c='gray', marker='P', s=5, label='Protein')
