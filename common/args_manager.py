...
def get_args():
    ...
    parser.add_argument("--fuse_name", type=str, default="all_to_one")
    parser.add_argument("--fuse_all_to_one", type=int, default=1)
    ...
    parser.add_argument("--gnn_fuse_name", type=str, default="all_to_one")
    parser.add_argument("--gnn_epochs", type=int, default=10)
    parser.add_argument("--gnn_name", type=str, default="all_to_one")

    parser.add_argument("--eval_model_name", type=str, default="all_to_one")
