...
def get_args():
    ...
    parser.add_argument("--fuse_epochs", type=int, default=250)
    ...
    parser.add_argument("--gnn_lr", type=float, default=0.0001)
    ...
    parser.add_argument("--gnn_epochs", type=int, default=250)
